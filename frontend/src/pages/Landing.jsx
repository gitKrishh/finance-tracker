        ...
        <div className="bg-gray-50 font-sans text-gray-800">
            ...
            <main>
                ...
                <section className="py-16 sm:py-20 bg-gray-50">
                    <div className="container mx-auto px-6 text-center">
                        <h2 className="text-3xl sm:text-4xl font-bold mb-4">Why You'll Love SpendTrack</h2>
                ...
                <section className="bg-blue-600 text-white">
                    <div className="container mx-auto px-6 py-16 sm:py-20 text-center">
                        ...
                        <Link to="/register" className="bg-white hover:bg-gray-100 text-blue-600 font-bold py-4 px-8 rounded-lg shadow-xl text-base sm:text-lg transition duration-300 transform hover:scale-105">
            ...
            <footer className="bg-gray-800 text-white">
                <div className="container mx-auto px-6 py-6 text-center">
                    <p>&copy; {new Date().getFullYear()} SpendTrack. All Rights Reserved.</p>
                </div>
            </footer>
        </div>
    );
